...
image_mean_3 = half_value_filter(image,3);
subplot(2,2,2);
imshow(image_mean_3)
xlabel('half value filter/3');

image_mean_5 = half_value_filter(image,5);
subplot(2,2,3);
imshow(image_mean_5)
xlabel('half value filter/5');

image_mean_9 = half_value_filter(image,9);
subplot(2,2,4);
imshow(image_mean_9)
xlabel('half value mean/9');
