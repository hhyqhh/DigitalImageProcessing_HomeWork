...
image_mean_3 = max_value_filter(image,3);
subplot(2,2,2);
imshow(image_mean_3)
xlabel('max value filter/3');

image_mean_5 = max_value_filter(image,5);
subplot(2,2,3);
imshow(image_mean_5)
xlabel('max value filter/5');

image_mean_9 = max_value_filter(image,9);
subplot(2,2,4);
imshow(image_mean_9)
xlabel('max value mean/9');
